...
namespace Archipelago.RetroArchClient.Tests.OcarinaOfTime.Services
{
	public class ConfigurationServiceTests
	{
		...
		private Func<ConfigurationSettings> GetTestConfigurationSettings = 
		...
		public void LoadConfigurationSettings_WithDefaultUserResponse_LoadsDefaultFile()
		{
			...
			var configService = new TestConfigurationService(_mockUserPromptService.Object, _mockFileService.Object, true, expectedConfigurationSettings);
			...
			_mockFileService
				.Setup(m => m.TryLoadJsonFile<ConfigurationSettings>("path/to/file/config.json", 
	...
	public class TestConfigurationService : ConfigurationService
	{
		...
		public TestConfigurationService(IUserPromptService userPromptService,
